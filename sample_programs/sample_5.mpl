...
print "First, it is shown in the source code, that by putting //, the rest of the line is commented away."; // Rest of the line can be commented with two backslashes.
